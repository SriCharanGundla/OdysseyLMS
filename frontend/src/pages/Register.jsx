    ...
    <section class="text-gray-600 body-font">
      <div class="container px-5 py-16 mx-auto flex flex-wrap items-center">
        <div class="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:m-auto w-full mt-10 md:mt-0">
          ...
          <div class="relative mb-4">
            <label for="re-password" class="leading-7 text-sm text-gray-600">
              Re-enter Password
            </label>
            <input
              type="password"
          ...
          <button class="text-white rounded-md bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg">
            Sign Up
          </button>
